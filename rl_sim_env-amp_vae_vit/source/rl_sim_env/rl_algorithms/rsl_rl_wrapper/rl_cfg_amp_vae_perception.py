...
@configclass
class AmpVaePerceptionPpoActorCriticCfg:
...
@configclass
class AmpVaePerceptionPpoAlgorithmCfg:
...
@configclass
class AmpVaePerceptionOnPolicyRunnerCfg:
    ...
    policy: AmpVaePerceptionPpoActorCriticCfg = MISSING
    """The policy configuration."""

    algorithm: AmpVaePerceptionPpoAlgorithmCfg = MISSING
