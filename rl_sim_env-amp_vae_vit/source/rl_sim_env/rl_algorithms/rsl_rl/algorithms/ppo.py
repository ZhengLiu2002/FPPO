...
from rl_algorithms.rsl_rl.modules import ActorCritic
from rl_algorithms.rsl_rl.storage import RolloutStorage
...
class PPO:
    ...
    def act(self, obs, critic_obs, actor_obs=None, vae_obs_history=None):
    ...
    def process_env_step(self, rewards, dones, infos, costs=None, next_actor_obs=None, next_amp_obs=None):
