...
class RewardsCfg:
    ...
    undesired_contacts = RewTerm(
        ...
        weight=-0.1,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*THIGH"), "threshold": 0.1},
    )
...
@configclass
class AmpVaeVitEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the AMP-VAE-VIT environment."""
