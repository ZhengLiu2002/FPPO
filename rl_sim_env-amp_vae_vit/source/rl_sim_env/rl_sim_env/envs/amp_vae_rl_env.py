...
class AmpVaeRLEnv(ManagerBasedEnv, gym.Env):
    ...
    def __init__(self, cfg: AmpVaeEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        # number of robot joints (used for joint_pos / joint_vel observations, includes arm joints)
