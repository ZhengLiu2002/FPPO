...
from rl_algorithms.rsl_rl_wrapper import AmpVaeOnPolicyRunnerCfg, AmpVaeVecEnvWrapper
...
def main():
    ...
    agent_cfg: AmpVaeOnPolicyRunnerCfg = cli_args.parse_amp_vae_cfg(args_cli.task, args_cli)
    ...
    if args_cli.use_pretrained_checkpoint:
        resume_path = get_published_pretrained_checkpoint("amp_vae", args_cli.task)
        if not resume_path:
    ...
    ppo_runner = AMPVAEOnPolicyRunner(env, agent_cfg.to_dict(), log_dir=None, device=agent_cfg.device)
